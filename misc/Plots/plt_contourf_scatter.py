...
gbbfile='/scratch1/BMC/gsd-fv3-dev/MAPP_2018/bhuang/JEDI-2020/JEDI-FV3/NRTdata_UFS-Aerosols/gocart_emissions/nexus/GBBEPx/GBBEPx_all01GRID.emissions_v004_20230815.nc'
#gbbfile='/scratch2/BMC/public/data/grids/nesdis/GBBEPx/0p1deg/GBBEPx-all01GRID_v4r0_20230815.nc'
ncind=open_ncfile(gbbfile)
#Ope
#lat=ncind.variables['Latitude'][:]
#lon=ncind.variables['Longitude'][:]
#Li
lat=ncind.variables['lat'][:]
lon=ncind.variables['lon'][:]
bc=ncind.variables['BC'][0,:,:]
ncind.close()
...
data=bc*10e9
tstr='BC (10e-9 kg/m2/s)'
ptitle='GBBEPx V004 on 20230815'
fsize1=14
fsize2=14
fsize3=14
ccmap=cmapaod
...
lons, data = map.shiftdata(lons, datain = data, lon_0=0)
x,y=map(lons, lats)
cs=map.scatter(lons,lats, s=1, c=data, marker='.', cmap=ccmap, vmin=0.0, vmax=2.0)
cb=map.colorbar(cs,"right", size="2%", pad="2%")
pname='bc.png'
plt.savefig(pname)
plt.close(fig)
