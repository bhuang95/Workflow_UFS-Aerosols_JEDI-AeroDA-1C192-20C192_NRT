...
ENSANALEXEC=${HOMEgfs}/exec/calc_analysis.x
...
while [ ${IMEM} -le ${ENSED} ]; do
	...
	#HBO
        ATMFILE=${GDASENKFIN_GES}/${MEMSTR}/gdas.t${GH}z.atmf006.nemsio
        SFCFILE=${GDASENKFIN_GES}/${MEMSTR}/gdas.t${GH}z.sfcf006.nemsio
