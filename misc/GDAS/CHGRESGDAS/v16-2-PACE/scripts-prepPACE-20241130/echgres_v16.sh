...
### 20240506
#module use /scratch1/BMC/gsd-fv3-dev/MAPP_2018/bhuang/JEDI-2020/JEDI-FV3/expCodes/PACEData/UFS-UTIL/V20240506-develop/gsi_utils.fd/modulefiles
### new workflow
module use /scratch1/BMC/gsd-fv3-dev/MAPP_2018/bhuang/JEDI-2020/JEDI-FV3/expCodes/PACEData/global-workflow-20241130/global-workflow/sorc/gsi_utils.fd/modulefiles
### 20231126
#module use /scratch1/BMC/gsd-fv3-dev/MAPP_2018/bhuang/JEDI-2020/JEDI-FV3/expCodes/PACEData/UFS-UTIL/20231116-develop/gsi_utils.fd/modulefiles
...
###20240506
#ENSANALEXEC=/scratch1/BMC/gsd-fv3-dev/MAPP_2018/bhuang/JEDI-2020/JEDI-FV3/expCodes/PACEData/UFS-UTIL/V20240506-develop/gsi_utils.fd/install/bin/calc_analysis.x
###new workflow
#ENSANALEXEC=/scratch1/BMC/gsd-fv3-dev/MAPP_2018/bhuang/JEDI-2020/JEDI-FV3/expCodes/PACEData/global-workflow-20241130/global-workflow/sorc/gsi_utils.fd/install/bin/calc_analysis.x
ENSANALEXEC=/scratch1/BMC/gsd-fv3-dev/MAPP_2018/bhuang/JEDI-2020/JEDI-FV3/expCodes/PACEData/global-workflow-20241130/global-workflow/sorc/gsi_utils.fd/install/bin/calc_analysis-copyPRESSFC.x
###20231126
#ENSANALEXEC=/scratch1/BMC/gsd-fv3-dev/MAPP_2018/bhuang/JEDI-2020/JEDI-FV3/expCodes/PACEData/UFS-UTIL/20231116-develop/gsi_utils.fd/install/bin/calc_analysis.x

${NCP} ${ENSANALEXEC} ./calc_analysis.x
...
srun --epilog=/apps/local/bin/report-mem  --export=ALL -n 127 calc_analysis.x  calc_analysis.nml
ERR=$?
report-mem
[[ ${ERR} -ne 0 ]] && exit ${ERR}

if [ ${ERR} -eq 0 ]; then
   ${NMV} ${ENSANLDIR}/ratmanl.nc.${FHR} ${OUTFILE_ANL}
   ERR=$?
fi
[[ ${ERR} -ne 0 ]] && exit ${ERR}
...
${NCP} ${CHGRESNCEXEC} ./enkf_chgres_recenter_nc.x
...
srun --epilog=/apps/local/bin/report-mem --export=all -n 1 enkf_chgres_recenter_nc.x  chgres_nc_gauss.nml
ERR=$?
report-mem
[[ ${ERR} -ne 0 ]] && exit ${ERR}
...
srun --epilog=/apps/local/bin/report-mem  --export=all -n 36 chgres_cube
ERR=$?
report-mem
    [[ ${ERR} -ne 0 ]] && exit ${ERR}
