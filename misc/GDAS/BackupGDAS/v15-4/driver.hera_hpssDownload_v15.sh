...
DATES=2019100100 #2020010100 #2019061200 #2020052506 #2019061200
DATEE=2019103118 #2020052500  #2021032018  #2021032018 [Completed for cycs of 2020052506-2021032018]
gfs_ver=v15
...
EXTRACT_DIR=${TMPDIR}/${gfs_ver}-4/${cdate}
...
sbatch --parsable --partition=service --ntasks=1  -t $WALLT -A $PROJECT_CODE -q $QUEUE -J ${gfs_ver}-4_${cdate} \
