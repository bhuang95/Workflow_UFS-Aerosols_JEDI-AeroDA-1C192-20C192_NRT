...
DATES=2022120100 #2021032100
DATEE=2022123118  #2022123118 #2022123118 
gfs_ver=v16
...
EXTRACT_DIR=${TMPDIR}/${gfs_ver}-1/${cdate}
...
sbatch --parsable --partition=service --ntasks=1  -t $WALLT -A $PROJECT_CODE -q $QUEUE -J ${gfs_ver}-1_${cdate} \
