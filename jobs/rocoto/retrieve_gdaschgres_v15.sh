...
GROTCNTLOUT=${ROTDIR}/gdas.${GYMD}/${GH}/atmos
GROTENKFOUT=${ROTDIR}/enkfgdas.${GYMD}/${GH}/atmos
ROTCNTLOUT=${ROTDIR}/gdas.${CYMD}/${CH}/atmos
ROTENKFOUT=${ROTDIR}/enkfgdas.${CYMD}/${CH}/atmos
...
ERR=$?
[[ ${ERR} -ne 0 ]] && exit ${ERR}
mv ${GDASCNTLOUT}/gdas.t${CH}z.atmanl.${CASE_CNTL}.nc  ${ROTCNTLOUT}/gdas.t${CH}z.atmanl.nc
GDASCNTLRST=${GDASCNTLOUT}/RESTART
ROTCNTLRST=${ROTCNTLOUT}/RESTART
