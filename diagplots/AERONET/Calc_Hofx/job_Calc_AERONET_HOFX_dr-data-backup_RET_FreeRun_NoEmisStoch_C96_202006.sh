...
#SBATCH -D ./
#SBATCH -o /scratch2/BMC/gsd-fv3-dev/MAPP_2018/bhuang/JEDI-2020/JEDI-FV3/MISC/tmprun2/aeronet_hofx.log
#SBATCH -e /scratch2/BMC/gsd-fv3-dev/MAPP_2018/bhuang/JEDI-2020/JEDI-FV3/MISC/tmprun2/aeronet_hofx.log

SDATE=2020061600 # Starting cycle
EDATE=2020063018 # Ending cycle
CYCINC=6
TOPEXPDIR='/scratch2/BMC/gsd-fv3-dev/MAPP_2018/bhuang/JEDI-2020/JEDI-FV3/expRuns/UFS-Aerosols_RETcyc/'
	# Run dir
EXPNAMES='RET_FreeRun_NoEmisStoch_C96_202006'
	# Exp to run hofx
	# If expname contain FreeRun, will run hofx for cntlbkg only.
	# Otherwise, for both cntlbkg and cntnanl for DA experiment
CURDIR=/scratch2/BMC/gsd-fv3-dev/MAPP_2018/bhuang/JEDI-2020/JEDI-FV3/MISC/tmprun2
	# Temporary running dir
