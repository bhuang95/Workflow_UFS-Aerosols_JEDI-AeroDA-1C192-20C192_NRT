...
gbb_date='20171012'
gbbfile_orig=f'/scratch2/NCEPDEV/naqfc/Kate.Zhang/GBBPEx_v004/GBBEPx_all01GRID.emissions_v004_{gbb_date}.nc'

gbb_date1='20171013'
gbbfile_orig1=f'/scratch2/NCEPDEV/naqfc/Kate.Zhang/GBBPEx_v004/GBBEPx_all01GRID.emissions_v004_{gbb_date1}.nc'

gbbpre_pert=f'/scratch1/BMC/gsd-fv3-dev/MAPP_2018/bhuang/JEDI-2020/JEDI-FV3/NRTdata_UFS-Aerosols/gocart_emissions/nexus/GBBEPx/GBBEPx_all01GRID.emissions_v004_{gbb_date}t'
gbbsuf_pert=':00:00z.nc'
...
ncind=open_ncfile(gbbfile_orig)
...
ncind=open_ncfile(gbbfile_orig1)
...
cyc=f'{gbb_date1}12'
plot_map_scatter_1by1(lon, lat, data_diff, var, cmapaod, cyc, True, True, vmaxx_diff)

exit()

for phr in range(phrs+1):
    phrstr=str(phr).zfill(2)
    cyc=f'{gbb_date}{phrstr}'
    gbbfile_pert=f'{gbbpre_pert}{phrstr}{gbbsuf_pert}'

    ncind=open_ncfile(gbbfile_pert)
