...
cbarname='ViBlGrWhYeOrRe_reduceWhite'
mpl=0
white=100
reverse=0
...
cdate='20171012'
file_orig=f'/scratch1/BMC/gsd-fv3-dev/MAPP_2018/bhuang/JEDI-2020/JEDI-FV3/NRTdata_UFS-Aerosols/gocart_emissions/nexus/CEDS-linked/v2019/2017/CEDS.2019.emis.{cdate}.nc'

cdate1='20171013'
file_orig1=f'/scratch1/BMC/gsd-fv3-dev/MAPP_2018/bhuang/JEDI-2020/JEDI-FV3/NRTdata_UFS-Aerosols/gocart_emissions/nexus/CEDS-linked/v2019/2017/CEDS.2019.emis.{cdate1}.nc'

filepre_pert=f'/scratch1/BMC/gsd-fv3-dev/MAPP_2018/bhuang/JEDI-2020/JEDI-FV3/NRTdata_UFS-Aerosols/gocart_emissions/nexus/CEDS/v2019/2017/CEDS.2019.emis.{cdate}t'
filesuf_pert=f':00:00z.nc'
...
ncind=open_ncfile(file_orig)
lat=ncind.variables['lat'][:]
lon=ncind.variables['lon'][:]
data_orig=ncind.variables[var][0,:,:]
ncind.close()
data=data_orig
data[data == 0]=np.nan
cyc=f'{cdate}00'
...
ncind=open_ncfile(file_orig1)
data_orig1=ncind.variables[var][0,:,:]
ncind.close()
data=data_orig1
data[data == 0]=np.nan
cyc=f'{cdate1}00'
...
data_diff=data_orig1-data_orig
...
for phr in range(phrs+1):
    ...
    cyc=f'{cdate}{phrstr}'
    file_pert=f'{filepre_pert}{phrstr}{filesuf_pert}'

    ncind=open_ncfile(file_pert)
    data=ncind.variables[var][0,:,:]
    ncind.close()
    data_diff=data-data_orig
...
cb=fig.colorbar(cs, cax=cbar_ax)
cb.ax.tick_params(labelsize=fsize2)
fig.suptitle(ptitle, fontsize=fsize1, fontweight="bold")
fig.tight_layout(rect=[0.0, 0.0, 0.90, 0.90])
pname='bc.png'
plt.savefig(pname)
plt.close(fig)
